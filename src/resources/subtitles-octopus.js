...
var SubtitlesOctopus = function (options) {
    ...
    self.init = function () {
        ...
        if (!self.worker) {
            ...
            // self.worker = new Worker(URL.createObjectURL(new Blob(["("+worker_function.toString()+")()"], {type: 'text/javascript'})));
...
if (window.SubtitlesOctopusOnLoad && typeof SubtitlesOctopusOnLoad == 'function') {
